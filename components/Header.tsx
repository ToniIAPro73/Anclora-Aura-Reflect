...
const Header: React.FC = () => {
  return (
    <header className="text-center p-4 md:p-6 mb-2 relative">
      ...
      <div className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-full -mt-5 w-[60vw] max-w-3xl h-24 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-teal-400 blur-2xl opacity-25" />
    </header>
  );
};
