...
const App: React.FC = () => {
  ...
  const handleGenerate = useCallback(async (prompt: string, aspectRatio: string, temperature: number) => {
  ...
  return (
    <div className="min-h-screen text-white font-sans flex flex-col items-center p-4">
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <main>
          {error && (
            <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/30 text-red-300 px-4 py-3 rounded-lg relative text-center mb-6" role="alert">
